...
const Executive = () => {
  return (
    ...
    className="relative w-full h-screen md:h-[110vh]">
      <Image
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-bl from-amber-100/10 to-amber-200/10">
        <div className="flex flex-row justify-center items-center h-full w-full overflow-x-hidden">
          ...
          className="flex flex-col justify-center items-center md:h-full h-auto md:pt-40 py-10 p-2 text-center border-l border-amber-900 gap-y-5 bg-amber-100/80 md:w-[30%]">
            <motion.p
            initial={{ opacity: 0, x: "100%" }}
            animate={{ opacity: 1, x: 0 }}
            ...
            className="text-amber-900 text-left text-lg font-serif md:mx-10 mx-5">
              Indulge in spacious elegance with our premium Suite. Featuring a
              separate living area, king-size bed, deluxe bathroom, and top-tier
              amenities — perfect for a truly memorable stay.
            </motion.p>
            <StyledWrapper2>
